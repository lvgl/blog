...
In [lv_linux_frame_buffer](https://github.com/littlevgl/lv_linux_frame_buffer) repository you find an [Eclipse CDT](https://www.eclipse.org/cdt/) project to try out the plain frame buffer based GUI with a Linux PC. 
