...
Important: " The toolchain programs access ESP-IDF using IDF_PATH environment variable. This variable should be set up on your PC, otherwise projects will not build."  Please follow the procedures from Setup Path to ESP-IDF to resolve it. 
